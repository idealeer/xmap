XMap 已成为网络测量和安全研究领域的一个强大工具，在众多高影响力的学术论文中被广泛认可和引用。其高效发现和分析 IPv6 网络外围的能力，使其成为探索大规模网络扫描安全影响的研究人员的重要资源。以下是已使用或引用了 XMap 的著名出版物列表，展示了其在推动网络安全和测量技术发展方面的重要影响：
...
- [其他论文](https://scholar.google.com/scholar?oi=bibs&hl=en&cites=3737757293110831577) 引用此工具或论文