...
XMap operates on GNU/Linux, macOS, and BSD. XMap currently has implemented probe modules for ICMP Echo scans, TCP SYN scans, [UDP probes](https://github.com/idealeer/xmap/blob/master/examples/udp-probes/README), and **DNS scans (stateless, stateful, address-spoofing, and EDNS)**.
...
XMap Copyright 2021-2025 Xiang Li from All-in-One Security and Privacy Lab (AOSP Lab) Nankai University
